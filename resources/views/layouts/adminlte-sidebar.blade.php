  ...
  <div class="sidebar">
      ...
      <nav class="mt-2">
          <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
              ...
              <li class="nav-item">
                  <a href="{{ route('roomtype.index') }}" class="nav-link {{ request()->routeIs('roomtype.index') ? 'active' : '' }}">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Room Types</p>
                  </a>
              </li>
              <li class="nav-item">
                  <a href="{{ route('roomfacility.index') }}" class="nav-link {{ request()->routeIs('roomfacility.index') ? 'active' : '' }}">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Room Facility</p>
                  </a>
              </li>
              <li class="nav-item">
                  <a href="{{ route('hotelfacility.index') }}" class="nav-link {{ request()->routeIs('hotelfacility.index') ? 'active' : '' }}">
                      <i class="far fa-circle nav-icon"></i>
                      <p>Hotel Facility</p>
                  </a>
              </li>
