        ...
        <div class="booking_table d_flex align-items-center">
            ...
            <div class="container">
                <div class="banner_content text-center">
                    ...
                    <h2>Reservasi Hotel SEADANYA</h2>
                ...
                @foreach ($roomTypes as $item)
                    <div class="col-lg-4 col-sm-6">
                        <div class="accomodation_item text-center">
                            ...
                            <p>Kamar Tersedia: {{ $item->available_rooms }}</p> <!-- Menampilkan jumlah kamar tersedia -->
                        </div>
                    </div>
                @endforeach
            </div>
    ...
    <section class="about_history_area section_gap" id="about">
        <div class="container">
            <div class="row">
                ...
                <div class="col-md-6">
                    <img class="img-fluid" src="{{ asset('images/kamar/hotel.jpg') }}" alt="img">
                </div>
            </div>
        </div>
    </section>
