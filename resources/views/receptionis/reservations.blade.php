                    ...
                    <div class="col-md-12">
                        <table id="transaction" class="display" style="width:100%">
                            ...
                            <tbody>
                                    ...
                                    <tr class="text-center">
                                        ...
                                        <td>
                                            ...
                                            @elseif ($item->status == 'process')
                                                <a class="btn btn-sm btn-primary" data-toggle="modal" data-target="#{{ 'proofModal'.$item->id }}">Proof</a>

                                                <div class="modal fade" id="{{ 'proofModal'.$item->id }}" tabindex="-1" role="dialog" aria-labelledby="proofModalLabel" aria-hidden="true">
                                                    <div class="modal-dialog">
                                                        <div class="modal-content">
                                                            <div class="modal-header">
                                                                <h4 class="modal-title" id="proofModalLabel">Proof Image</h4>
                                                            </div>
                                            ...
                                            @elseif ($item->status == 'waiting for payment')
                                                <button type="button" class="btn btn-primary btn-sm" data-toggle="modal" data-target="#uploadProof{{ $item->id }}">Upload Proof</button>
                                ...
                                @empty
                                    <tr class="text-center">
                                        <td colspan="11">Tidak ada transaksi</td>
                                    </tr>
                                @endforelse
                            </tbody>
                        </table>
